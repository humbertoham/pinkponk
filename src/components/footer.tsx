            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex py-2 lg:py-0  space-x-4 items-center">
                        ...
                        <a href="https://www.instagram.com/pinkponk.dev" target='blank_' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <FaInstagram className='text-xl'/>
                            <span className="sr-only">Instagram</span>
                        </a>
                        <a href="https://x.com/pinkponkdev" target='blank_' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
